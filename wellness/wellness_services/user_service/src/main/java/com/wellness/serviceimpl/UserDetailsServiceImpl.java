...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	@Override
	public String updateProfilePicture(MultipartFile file, String email) throws InvalidImageFileException {
		Optional<UserDetails> user = userRepo.findByEmail(email);
		if (user.isPresent()) {
			UserDetails userDetails = user.get();
	...
	public byte[] viewProfilePicture(String email) {
		Optional<UserDetails> fileData = userRepo.findByEmail(email);
